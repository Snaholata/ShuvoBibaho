...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
      ...
      <video width="100%" controls><source src="evv.mp4" type="video/mp4"></video>
    ...
    <div class="container">
		...
		<div class="col-sm-4">
				<div class="card box-shadow">
					<img class="card-imd-top" src="ev1.jpg">
					<div class="card-body">
						<h4 class="card-title">Lamore Event Planner</h4>
                       
						<a href="lamoreeventport.php" class="btn btn-outline-secondary">See More</a>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-4">
				<div class="card box-shadow">
					<img class="card-imd-top" src="ev3.png">
					<div class="card-body">
						<h4 class="card-title">The 20's Production</h4>
						
						<a href="the20sport.php" class="btn btn-outline-secondary">See More</a>
					</div>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="card box-shadow">
					<img class="card-imd-top" src="ev6.jpg">
					<div class="card-body">
						<h4 class="card-title">Enliven Event</h4>
						
						<a href="enlivenport.php" class="btn btn-outline-secondary">See More</a>
					</div>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="card box-shadow">
					<img class="card-imd-top" src="ev4.jpg">
					<div class="card-body">
                        <h4 class="card-title">Wedding Berries</h4>
                        
						<a href="weddingberries.php" class="btn btn-outline-secondary">See More</a>
					</div>
				</div>
			</div>
